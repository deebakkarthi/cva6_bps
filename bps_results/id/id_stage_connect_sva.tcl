...
# ----------------------------------------
# started   : 2026-05-09 19:05:03 EDT
# created   : 2026-05-09 19:14:14 EDT
# hostname  : node1-s.ece.Virginia.EDU.UVAECE
# pid       : 2208700
# arguments : '-label' 'session_0' '-console' '//127.0.0.1:44617' '-style' 'windows' '-data' 'AAAAn3icY2BgYAQjBpv6////M4AB4wMIzWDDyIAKQHwmVJHABhSagYEVIckMxHwMugx5DPkM8QzpDKUMmUARDqBICUMyQw6QLQEUSQHKFQNFEoEqUhn04HJAAABtyA+F' '-bridge_url' '10.230.53.157:35245' '-proj' '/net/marysrock.ece.Virginia.EDU/maryisan/users/brg8ve/cva6_verif/jgproject/sessionLogs/session_0' '-init' '-hidden' '/net/marysrock.ece.Virginia.EDU/maryisan/users/brg8ve/cva6_verif/jgproject/.tmp/.initCmds.tcl' 'id_stage.tcl'
# ----------------------------------------
#
...
analyze -clear
analyze -sv09 -req +define+JASPER_SVA_NO_BIND /net/marysrock.ece.Virginia.EDU/maryisan/users/brg8ve/cva6_verif/jgproject/id_stage.sva
